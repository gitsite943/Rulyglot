...
<!-- pricing  -->
<div id="pricing" class="relative isolate px-6 py-16 sm:py-20 lg:px-8">


  <!-- Header -->
  <div class="mx-auto max-w-4xl text-center">
    <h2 class="text-base font-semibold text-indigo-600">Pricing</h2>
    <p class="mt-2 text-5xl font-semibold tracking-tight text-gray-900 sm:text-6xl">Your First Step Toward Speaking Russian</p>
  </div>
  <p class="mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-gray-600 sm:text-xl">
    Book a single session and experience personalized Russian language learning with a native speaker.
  </p>
  ...
  <div class="flex justify-center mt-20">
    <div class="max-w-md w-full rounded-3xl border border-gray-200 shadow-xl p-8 text-center">
      ...
      <p class="mt-4 text-gray-600 text-base">
        Get started with a full 60-minute free lesson with a native Russian speaker. Meet your instructor, experience the method, and decide afterward if you want to continue.
      </p>
